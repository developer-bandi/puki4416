...
![header](https://capsule-render.vercel.app/api?type=waving&color=FFA500&height=200&descAlign=50&fontAlign=50&section=header&text=Sangdu Kim&fontSize=65&fontColor=2E2E2E&animation=twinkling)  
<div align="center">
    
## 👨🏻‍💻introduce👨🏻‍💻
    
    프론트 엔드 분야를 공부하고 있는 학생입니다
    자바스크립트의 장점을 잘살리기위해 객체지향과 함수형 프로그래밍을 학습하고 있습니다.
    버그가 발생해도 당황하지않고 침착하게 해결할수 있는 자세를 가지고 있습니다.
    변화하는 프론트엔드 생태계에 맞추어 끊임없이 학습합니다.
...
![storybook](https://img.shields.io/badge/storybook-FF4785.svg?style=for-the-badge&logo=storybook&logoColor=white) ![jest](https://img.shields.io/badge/jest-C21325.svg?style=for-the-badge&logo=jest&logoColor=white)<br />
...
## ⭐️Problem Solved⭐️
[![Solved.ac
프로필](http://mazassumnida.wtf/api/v2/generate_badge?boj=jskim0427)](https://solved.ac/jskim0427)
</div>
